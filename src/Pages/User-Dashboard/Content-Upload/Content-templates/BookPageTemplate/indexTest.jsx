...
function BookPageTemplate() {
    ...
    const sections = [
        ...
        { section: "Blurb", sectionName: "Blurb", optional: false },
        { section: "Synopsis", sectionName: "Synopsis", optional: false },
        { section: "Chapters", sectionName: "Chapters", optional: true },
    ];
